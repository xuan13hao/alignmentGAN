...
ADV_TRAIN_EPOCHS = 30
POS_NEG_SAMPLES = 500
REF_NEG_SAMPLES = 253979
SEQ_LENGTH = 111
GEN_EMBEDDING_DIM = 128 # 512
GEN_HIDDEN_DIM = 128 # 768
...
def read_edits(k = 1, file='edits.pkl', pad_token='PAD',num=None):
...
if __name__ == '__main__':
    ...
    for epoch in range(ADV_TRAIN_EPOCHS):
        ...
        train_discriminator(dis, dis_optimizer, real, gen, oracle, 10, 3)
    try:
